...
class Lab4_2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Demdulador", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Demdulador")
        ...
        # Blocks
        ##################################################
        self._fc_range = Range(88M, 108M, 100k, 88.1M, 200)
        ...
        self.uhd_usrp_source_0.set_samp_rate(10M)
        self.uhd_usrp_source_0.set_time_now(uhd.time_spec(time.time()), uhd.ALL_MBOARDS)

        self.uhd_usrp_source_0.set_center_freq(88.1M, 0)
        ...
        self._Ga_range = Range(0, 3, 100m, 1, 200)
